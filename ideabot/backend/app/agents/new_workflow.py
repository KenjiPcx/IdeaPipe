...
# Example agents
from app.agents.z_example.analyst import create_analyst
from app.agents.z_example.reporter import create_reporter
from app.agents.z_example.researcher import create_researcher

# Import our agent team
from app.agents.a_problem_definition.problem_definer import create_problem_definer
from app.agents.b_initial_research import create_market_research, create_competitor_analysis, create_customer_insights, create_trends_research
...
def create_workflow(chat_history: Optional[List[ChatMessage]] = None, **kwargs):
    ...
    # problem definition
    problem_definer = create_problem_definer(chat_history=chat_history)
...
class FinancialReportWorkflow(Workflow):
    ...
    async def start(self, ctx: Context, ev: StartEvent) -> ResearchEvent | ReportEvent:
        ...
        ctx.data["problem_defined"] = False
